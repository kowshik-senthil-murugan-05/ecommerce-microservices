...
import com.ecommerce.cart_service.cartitem.CartItem;
...
import com.ecommerce.cart_service.exceptionhandler.APIException;
import com.ecommerce.cart_service.exceptionhandler.ResourceNotFoundException;
...
//    private final ProductClient productClient;
    ...
    public CartServiceImpl (UserCartRepo userCartRepo)
    {
...
//                .orElseThrow(() -> new ResourceNotFoundException("Product", "productId", dto.productId));
        ...
        ProductDTO product = restTemplate.getForObject(
                "http://product-service/api/product/fetch/" + dto.productId,
                ProductDTO.class
        );
